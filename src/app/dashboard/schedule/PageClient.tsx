...
export default function SchedulerApp() {
  ...
  useEffect(() => {
    ...
    // Build a fingerprint to detect real changes (ignore travel segments)
  ...
  const handleAddTeam = useCallback(async () => {
    ...
    if (data) {
      // Reload from DB to get the new team with correct ID
      await loadFromDb();
    }
  ...
  const handleRemoveTeam = useCallback(async (teamId: string) => {
    ...
    // Delete schedule jobs and schedules for this team first
