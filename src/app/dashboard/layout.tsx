...
const NAV_ITEMS: { label: string; href: string; icon: React.ReactNode; adminOnly?: boolean }[] = [
  {
    label: 'Schedule',
    ...
    <div className="h-full flex">
      ...
      <aside
        className={`
          ...
          w-[260px] bg-white border-r border-border-light
          flex flex-col
      ...
      <div className="flex-1 flex flex-col min-h-0 min-w-0">
        ...
        <div className="lg:hidden shrink-0 h-14 border-b border-border-light flex items-center px-4 gap-3 bg-white">
          <button
            ...
            className="p-2 -ml-2 rounded-lg hover:bg-surface-hover text-text-secondary"
          >
